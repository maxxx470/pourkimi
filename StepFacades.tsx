...
export interface StepFacadesProps {
  files: UploadedFile[];
...
export const StepFacades: React.FC<StepFacadesProps> = ({
  files,
  onAddFiles,
  onRemoveFile,
  onNext,
  ...
  const handleContinue = () => {
    ...
    if (!hasValidFile) {
      setError('Ajoutez au moins une façade pour continuer');
      return;
    }
    setError(null);
    onNext();
    ...
    <div className="space-y-3.5 animate-[fadeUp_220ms_cubic-bezier(0.23,1,0.32,1)_forward]">
      ...
      >
        ...
        <p className="font-sans text-[12px] text-[#475569] leading-relaxed mb-3.5">
          Les façades permettent de confirmer les ouvertures et la composition verticale du
          bâtiment.
        </p>
